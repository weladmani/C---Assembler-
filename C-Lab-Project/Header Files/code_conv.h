...
#define OPCODE_BITS_SHIFT 11 /* number of shift left needed to reach the opcode LSB 11-14 */
#define SOURCE_BITS_SHIFT 7 /* number of shift left needed to reach the source operand LSB 7-10 */
#define DEST_BITS_SHIFT 3 /* number of shift left needed to reach the dest operand LSB 3-6 */

#define SOURCE_BITS_SHIFT_REG 6 /* number of shift left needed to reach the source register operand LSB 6-8 */
#define DEST_BITS_SHIFT_REG 3 /* number of shift left needed to reach the dest register operand LSB 3-5 */

/* number of shift left needed to reach method for source or dest */
#define DIRECT_ADDRESSING 0
#define LABEL_ADDRESSING 1
#define REG_INDICATOR_ADDRESSING 2
